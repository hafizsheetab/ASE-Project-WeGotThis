...
const LoginTextInputs = () => {
    ...
    const handleClickShowPassword = () => setLoginForm({
        ...loginForm,
        ...
        <TextInputField
            ...
            endIcon={
                <InputAdornment position="end">
                    <IconButton
                    aria-label={
                        loginForm.isPasswordVisible ? 'hide the password' : 'display the password'
                    }
                    ...
                    edge="end"
                    >
                    {loginForm.isPasswordVisible ? <VisibilityOff /> : <Visibility />}
                    </IconButton>
                </InputAdornment>
              }
            required={true}
