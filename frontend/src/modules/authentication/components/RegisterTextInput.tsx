    ...
    <form onSubmit={handleSubmit} className={styles.form}>
        ...
        <TextInputField 
            ...
            endIcon={
                <InputAdornment position="end">
                    <IconButton
                    aria-label={
                        registerForm.isPasswordVisible ? 'hide the password' : 'display the password'
                    }
                    onClick={() =>
                    ...
                    edge="end"
                    >
                    {registerForm.isPasswordVisible ? <VisibilityOff /> : <Visibility />}
                    </IconButton>
                </InputAdornment>
              }
        ...
        <FormControlLabel
            ...
            control={
                ...
                />} 
                label={<Typography variant="caption" style={{cursor:'default'}}>
